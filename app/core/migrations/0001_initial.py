# Generated by Django 4.1.1 on 2022-10-30 16:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.TextField(blank=True)),
                ('pre_sale_price', models.CharField(default='', max_length=255)),
                ('pre_sale_date', models.CharField(default='', max_length=255)),
                ('premises_delivery_date', models.CharField(default='', max_length=255)),
                ('rent_price_approximate', models.CharField(default='', max_length=255)),
                ('resale_price_approximate', models.CharField(default='', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_referral', models.ManyToManyField(to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Recipe',
        ...
        migrations.AddField(
            model_name='user',
            name='referrals',
            field=models.ManyToManyField(to='core.referral'),
        ),
        migrations.AddField(
            model_name='user',
